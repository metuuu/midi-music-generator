...
const BLURBS: Blurb[] = [
  ...
  { text: 'a major seventh on every strong beat, and nobody apologising for it', styles: ['citypop'] },
  { text: 'a coastline, a car, and a chord change every bar', styles: ['citypop'], moods: ['summer'] },
  { text: 'the band can read, and the arranger knew it', styles: ['citypop', 'chamber'] },
