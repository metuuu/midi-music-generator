 ...
 * was this one. There are five now — `sargam` was written for the Indian genre
 * after this paragraph — and it sits at one end of the fourth bullet below rather
 * than threatening it: it has no codas at all, where `machine` sounds 0.55 of the
 * ones it writes, and the 0.4 that is the whole reason `scat` is here falls
 * exactly in the middle of the five. The count is corrected; the choice is not.
 *
 ...
 * writing a sixth language into a file this genre does not own — a fifth when
