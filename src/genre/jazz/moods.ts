...
const moods: Mood[] = [
  {
    ...
    styleBias: { ballad: 3.0, blues: 1.6, swing: 0.9, modal: 1.2, bossa: 0.7, bebop: 0.3, gypsy: 0.4 },
  ...
  },
  {
    ...
    styleBias: { swing: 3.0, blues: 1.6, bebop: 1.4, gypsy: 1.3, bossa: 0.6, ballad: 0.2, modal: 0.5 },
  ...
  },
  {
    ...
    styleBias: { bossa: 2.4, modal: 2.0, ballad: 1.5, swing: 1.2, blues: 0.8, bebop: 0.3, gypsy: 0.4 },
  ...
  },
  {
    ...
    styleBias: { bebop: 3.2, swing: 1.8, blues: 1.3, gypsy: 1.6, bossa: 0.3, ballad: 0.1, modal: 0.5 },
  ...
  },
  {
    ...
    styleBias: { blues: 3.4, swing: 1.3, bebop: 0.9, ballad: 0.8, modal: 0.6, bossa: 0.3, gypsy: 0.5 },
  ...
  },
  {
    ...
    styleBias: { modal: 3.0, ballad: 2.2, bossa: 1.4, swing: 0.6, blues: 0.5, bebop: 0.15, gypsy: 0.2 },
